...
// Шаблоны регулярных выражений для поставщиков
...
export interface VKPost {
  ...
  is_manually_edited?: boolean; // Флаг ручной правки куратора
  ...
  originalText?: string;          // Исходный неочищенный текст
  processedText?: string;         // Обработанный очищенный текст (результат чистки)
}
