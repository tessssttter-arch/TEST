  ...
  return (
    <div id="table-toolbar" className="space-y-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl shadow-2xs">
      ...
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="flex items-center gap-1.5 border border-slate-200 dark:border-slate-800 rounded-lg p-1.5 bg-slate-50 dark:bg-slate-950 shrink-0">
          <Database size={13} className="text-slate-400 ml-1 shrink-0" />
          <select
            id="preset-quick-selector"
            value={selectedPresetId}
            onChange={handlePresetChange}
            className="text-[11px] font-bold bg-transparent outline-hidden text-slate-700 dark:text-slate-300 select-none cursor-pointer pr-1"
          >
          ...
          <button
            ...
            className="p-1 text-slate-400 hover:text-[#4C75A3] hover:bg-white dark:hover:bg-slate-900 rounded-md transition-all cursor-pointer shrink-0"
          >
            <Settings size={13} />
          </button>
        </div>
