...
// [AI-EDIT] Реализация парсера CSV для обратного импорта правок из Excel | 2026-06-16 16:50 | PARS/V2/TODO.md: 1
// [AI-CONTEXT] Используется для загрузки отредактированного куратором CSV и применения правок к editsMap хранилища. Зависимостей не добавляем.
