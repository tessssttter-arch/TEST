...
// [AI-EDIT] Создание диалога обратного импорта CSV для правок постов | 2026-06-15 | VkAnalyzer UI split
// [AI-CONTEXT] Диалог открывается отдельно, не вызывает clearAll, только bulkUpdatePostDetails.
// Диалог импорта правок из CSV/Excel. Используется после загрузки постов, чтобы обновить правки без потери данных.
