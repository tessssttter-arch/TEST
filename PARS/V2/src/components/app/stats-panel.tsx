  ...
  return (
    <div id="stats-dashboard-container" className="space-y-6">
      <div className="flex items-center gap-1 text-slate-800 dark:text-slate-200">
        <h3 className="font-bold text-lg">Сводная статистика выборки</h3>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl flex items-center gap-3">
          <div className="p-3 bg-indigo-50 text-indigo-600 dark:bg-indigo-950/80 dark:text-indigo-400 rounded-xl">
        ...
        <div className="p-4 bg-white dark:bg-slate-905 border border-slate-200 dark:border-slate-800 rounded-2xl flex items-center gap-3">
          <div className="p-3 bg-emerald-50 text-emerald-600 dark:bg-emerald-950/80 dark:text-emerald-400 rounded-xl">
            <span>₽</span>
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl">
          <h4 className="font-bold text-sm text-slate-700 dark:text-slate-300 mb-4 uppercase tracking-wider">Распределение товаров по диапазонам цен</h4>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between">
          <div>
            <h4 className="font-bold text-sm text-slate-700 dark:text-slate-300 mb-4 px-2 uppercase tracking-wider">Структура постов по типу контента</h4>
          ...
          <div className="space-y-2 mt-4 px-2">
            <div className="flex items-center justify-between text-xs py-1 px-2 rounded-lg bg-indigo-50/50 dark:bg-indigo-950/10">
              <span className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400">
                <span className="w-2.5 h-2.5 rounded-full bg-indigo-500"></span>
                <Image size={13} className="text-indigo-500" />
                С картинками
              </span>
              <span className="font-bold text-slate-800 dark:text-slate-200">{stats.posts_with_images}</span>
            </div>
            <div className="flex items-center justify-between text-xs py-1 px-2 rounded-lg bg-slate-50 dark:bg-slate-850">
              <span className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400">
                <span className="w-2.5 h-2.5 rounded-full bg-slate-400"></span>
                <FileText size={13} className="text-slate-400" />
                Только текст
              </span>
              <span className="font-bold text-slate-800 dark:text-slate-200">{stats.posts_text_only}</span>
            </div>
          </div>
        </div>
      </div>
